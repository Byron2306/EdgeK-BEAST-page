# BEAST Definitive Mega-Test Master Evidence Bundle
...
- Designed controlled core: `450` observations
- Canonical staged analysis records: `198` (not IID; overlaps disclosed)
- Mature NVIDIA deterministic reuses: `12`
- Mature NVIDIA QPCCD: `12/24 = 0.5`
- Live mutation blocks/recoveries: `6/6`
- Primary cross-provider cases: `12/12`
- Groq scout cases: `6/6`
- Primary estimated avoided tokens: `18768`
